        ...
        return (
            <div className = "whole_div">
                <div className = "body_div_show_patient_image ">
                    <img  src={show_patient_image_example} className = "image_show_patient_image"/>
                    <button className = "button_concept_show_patient_image"> Download Image</button>
                    <button className = "button_concept_show_patient_image" onClick={() => this.props.submit_function(previous_page,return_value)}> Back To Previous Page</button>
                </div>
            </div>
